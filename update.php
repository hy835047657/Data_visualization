...

{
    ...
    for($j=0;$j<7;$j++)
    {
        ...
        echo $arr[$i];
        echo $new;
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='07：00-08：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(13, 19);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='08：00-09：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(4, 8);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='09：00-10：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);

        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='10：00-11：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='11：00-12：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='12：00-13：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='13：00-14：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='14：00-15：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='15：00-16：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='16：00-17：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(4, 8);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='17：00-18：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(7, 13);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='18：00-19：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(8, 14);

        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='19：00-20：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='20：00-21：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='21：00-22：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(2, 6);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='22：00-23：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
        $new = rand(1, 5);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '沙依巴克区' AND weekday = '$week1[$j]' AND extime='23：00-24：00' AND datatype='呼叫总量' AND location='$arr[$i]'", $conn);
...

{
    ...
    for($j=0;$j<7;$j++)
    {
        ...
        echo $arr2[$i];
        echo $new;
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='07：00-08：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(13, 19);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='08：00-09：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(4, 8);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='09：00-10：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);

        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='10：00-11：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='11：00-12：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='12：00-13：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='13：00-14：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='14：00-15：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='15：00-16：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='16：00-17：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(4, 8);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='17：00-18：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(7, 13);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='18：00-19：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(8, 14);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='19：00-20：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='20：00-21：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='21：00-22：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(2, 6);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='22：00-23：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
        $new = rand(1, 5);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '水磨沟区' AND weekday = '$week1[$j]' AND extime='23：00-24：00' AND datatype='呼叫总量' AND location='$arr2[$i]'", $conn);
...

{
    ...
    for($j=0;$j<7;$j++)
    {
        ...
        echo $arr1[$i];
        echo $new;
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='07：00-08：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(13, 19);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='08：00-09：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(4, 8);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='09：00-10：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);

        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='10：00-11：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='11：00-12：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='12：00-13：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='13：00-14：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='14：00-15：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='15：00-16：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='16：00-17：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(4, 8);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='17：00-18：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(7, 13);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='18：00-19：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(8, 14);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='19：00-20：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='20：00-21：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(3, 7);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='21：00-22：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(2, 6);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='22：00-23：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
        $new = rand(1, 5);
        $check_query = mysql_query("UPDATE didi SET totalamount = '$new' WHERE area = '新市区' AND weekday = '$week1[$j]' AND extime='23：00-24：00' AND datatype='呼叫总量' AND location='$arr1[$i]'", $conn);
